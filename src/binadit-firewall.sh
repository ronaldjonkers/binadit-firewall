...
fw_features() {
  ...
  ${GREEN}UDP_PORTS${NC}               Ports open for both incoming and outgoing UDP.
                          Example: "53 51820"
  ${GREEN}BLOCKED_TCP_PORTS${NC}       TCP ports to explicitly block (overrides other rules).
  ${GREEN}BLOCKED_UDP_PORTS${NC}       UDP ports to explicitly block.
...
BLOCKED_TCP_PORTS BLOCKED_UDP_PORTS SSH_ALLOWED_IPS SSH_ALLOWED_IPS_IPV6 \
